...
(function () {
  ...
  const translations = {
    de: {
      ...
      about_p1: "Mohammad Al Hallak hat seinen Bachelor of Science in Informatik an der Westfälischen Hochschule abgeschlossen und studiert aktuell im Masterstudiengang Internet-Sicherheit.",
      about_p2: "Seine praktischen Schwerpunkte liegen in der Full-Stack- und Backend-Entwicklung, Datenanalyse, technischen Automatisierung und Security-nahen Softwareentwicklung.",
      about_p3: "Als Werkstudent bei Adecco sammelte er mehrjährige Erfahrung in KPI-Analysen, Reporting, Data Quality Management und der Automatisierung wiederkehrender Auswertungen.",
      about_p4: "Zusätzlich verfügt er über Projekterfahrung mit Java, Spring Boot, Python, FastAPI, PostgreSQL, REST APIs, JavaScript, Tailwind CSS, Docker sowie SQL- und NoSQL-Datenbanken.",
      stat_bsc: "Informatik",
    ...
    en: {
      ...
      about_p1: "Mohammad Al Hallak completed his Bachelor of Science in Computer Science at Westphalian University of Applied Sciences and is currently studying in the Internet Security master's programme.",
      about_p2: "His practical focus lies in full-stack and backend development, data analysis, technical automation and security-oriented software development.",
      about_p3: "As a working student at Adecco, he gained several years of experience in KPI analysis, reporting, data quality management and the automation of recurring evaluations.",
      about_p4: "He also has project experience with Java, Spring Boot, Python, FastAPI, PostgreSQL, REST APIs, JavaScript, Tailwind CSS, Docker as well as SQL and NoSQL databases.",
